...
public class TrackTemperatureData extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        LineDataSet dataSet = new LineDataSet(dataValues(), "Current Temperature");
        LineDataSet dataSet2 = new LineDataSet(dataValuesRec(), "Recommended Temperature");
        ...
        description.setText("All values in Celcius");
